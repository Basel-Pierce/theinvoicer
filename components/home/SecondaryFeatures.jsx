...
const features = [
  ...
  },
  {
    ...
    summary:
      '',
    description:
      'The act of copy-pasting a crypto address in order to tell the client where to send the funds, presents a MAJOR cyber security threat, as its very easy for an attacker to intercept the "copy-paste", replacing the pasted address for another one. As addresses don\'t make an apparent "sense", most of the times the victim does not realize that he is pasting a wallet different thatn the one copied. There is also human error to factor, as mistakes are very easily made, and crypto transfers are irreversible.',
